...
public class YouAMP {
    ...
    private static final Logger log = Logger.getLogger(YouAMP.class.getCanonicalName());
    ...
    public static void main(String[] args) {
        ...
        */
        try {
            setupLogging();
            log.fine("Starting");
            String videoId = "https://www.youtube.com/watch?v=V_c0aoOgWVg&list=RDV_c0aoOgWVg&start_radio=1";;
            String outdir = "/Users/unixexp/personal/home/";
    ...
    private static void play(String videoId, int format, String encoding, String userAgent, File outputdir, String extension) throws Throwable {
        ...
        log.finer(entity.getContent().toString());
